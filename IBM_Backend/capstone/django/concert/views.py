...
def songs(request):
    ...
    songs = req.get("http://songs-sn-labs-kaysun.labs-prod-openshift-san-a45631dc5778dc6371c67d206ba9ae5c-0000.us-east.containers.appdomain.cloud/song").json()
...
def photos(request):
    ...
    # }]
    photos = req.get("https://pictures.120hlrgmlaku.us-south.codeengine.appdomain.cloud/picture").json()
